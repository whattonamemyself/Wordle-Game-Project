...
def newgame():
    ...
    if mode == 0:
        ...
        screen = Screen(canvas, window, gameOver, False, word)
    elif mode == 1:
        word = all_words.getRandom()
        screen = Screen(canvas, window, gameOver, True, word)
    elif mode == 2:
        ws = WordSearch(16,16)
        ws.genWordSearch()
...
def actualgame():
    ...
    statsDisplayer = StatsDisplayer(canvas, window, inputs, start, stop, "")
